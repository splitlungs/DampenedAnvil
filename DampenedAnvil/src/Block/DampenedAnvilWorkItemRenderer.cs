...
// public class DampenedAnvilWorkItemRenderer : IRenderer, IDisposable
// {
...
//     private DampenedAnvilBE beAnvil;
//     private Vec4f glowRgb = new Vec4f();
//     protected Vec3f origin = new Vec3f(0f, 0f, 0f);
//     protected Vec3f offSet = new Vec3f(0f, 0.375f, 0f);
//     public double RenderOrder => 0.5;
//     public int RenderRange => 24;
// 
//     public DampenedAnvilWorkItemRenderer(DampenedAnvilBE beAnvil, BlockPos pos, ICoreClientAPI capi)
//     {
//         this.pos = pos;
//         api = capi;
